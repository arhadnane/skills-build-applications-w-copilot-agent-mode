...
from .serializers import (
    OctoFitUserSerializer, ActivitySerializer,
    TeamSerializer, LeaderboardSerializer, WorkoutSerializer
)
...
def api_root(request, format=None):
    return Response({
        'users': reverse('octofit_user-list', request=request, format=format),
